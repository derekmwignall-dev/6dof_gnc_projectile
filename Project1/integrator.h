	...
	const Vector3& E, const Vector3& B, double dt, const Vector3& r, const Vector3& f_guidance)
{
	...
	Quaternion delta_orient{ Quaternion::fromAxisAngle(delta_ang_vel.normalize(), delta_ang_vel.magnitude()) };
